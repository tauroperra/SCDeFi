...
async function main() {
  ...
  console.log('💪 deployment of Token Factory started');

  // We get the contract to deploy
  const TokenFactoryCreate = await hre.ethers.getContractFactory("TokenFactory"); // deploy first, no constructor param dependency
  const tokenFactory = await TokenFactoryCreate.deploy(); //constructor param inside () here
